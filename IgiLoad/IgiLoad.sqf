...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_MOHAWK = ["I_Heli_Transport_02_F", "CH49_Mohawk_FG", "Marinir_CH49_Mohawk_FG", "NF_Merlin_black", "NF_Merlin_green"];
	...
	IL_Supported_Vehicles_C130J = ["USAF_C130J", "USAF_MC130","Cha_C130_USMC_1","Cha_C130_USMC_2","Cha_C130_AUS","Cha_C130_IDF","Cha_C130_BAF_1","Cha_C130_BAF_2","Cha_C130_RACS","Cha_C130_UNO","Cha_C130_AAF","Cha_C130_TKA","RHS_C130J"];
	...
	IL_Supported_Hunter = ["B_MRAP_01_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F", "Marinir_B_MRAP_01_FG" , "Marinir_MRAP_01_gmg_FG", "Marinir_MRAP_01_hmg_FG", "B_mas_mar_MRAP_01_med_F", "B_mas_mar_MRAP_01_F", "B_mas_mar_MRAP_01_gmg_F", "B_mas_mar_MRAP_01_hmg_F", "UK3CB_BAF_Jackal2_BASE_D","RHS_BMD_BASE","RHS_BMD2_BASE","RHS_BMD1_BASE","RHS_BMD1","RHS_BMD1K","RHS_BMD1P","RHS_BMD1PK","RHS_BMD1R","RHS_BMD2","RHS_BMD2M","RHS_BMD2K"];
	...
	IL_Supported_Hatchback = ["C_Hatchback_01_F", "C_Hatchback_01_sport_F", "O_mas_cars_UAZ_MG",  "O_mas_cars_UAZ_AGS30",  "O_mas_cars_UAZ_SPG9",  "O_mas_cars_UAZ_Unarmed",  "O_mas_cars_UAZ_Med"];
	IL_Supported_Hummvee = ["rc_hmmwv", "HMMWV2", "HMMWV_M1035", "M1114_AGS_ACR", "HMMWV_M1151_M2", "HMMWV2_M2", "HMMWV2_MK19", "HMMWV2_TOW", "HMMWV", "HMMWV_M2", "HMMWV_MK19", "HMMWV_TOW", "B_mas_HMMWV_M2", "B_mas_HMMWV_M134", "B_mas_HMMWV_SOV", "B_mas_HMMWV_SOV_M134", "B_mas_HMMWV_TOW", "B_mas_HMMWV_MK19", "B_mas_HMMWV_UNA", "B_mas_HMMWV_MEV", "B_mas_HMMWV_M2_des", "B_mas_HMMWV_M134_des", "B_mas_HMMWV_SOV_des", "B_mas_HMMWV_SOV_M134_des", "B_mas_HMMWV_TOW_des", "B_mas_HMMWV_MK19_des", "B_mas_HMMWV_UNA_des", "B_mas_HMMWV_MEV_des", "B_mas_cars_Hilux_MG",  "B_mas_cars_Hilux_AGS30",  "B_mas_cars_Hilux_SPG9",  "B_mas_cars_Hilux_RKTS",  "B_mas_cars_Hilux_Unarmed",  "B_mas_cars_Hilux_Med", "B_mas_cars_Hilux_M2", "B_mas_cars_LR_Unarmed", "B_mas_cars_LR_Med", "B_mas_cars_LR_M2", "B_mas_cars_LR_Mk19", "B_mas_cars_LR_TOW", "B_mas_cars_LR_SPG9"];
	...
	IL_Supported_Supply_Crate = ["B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F", "rhsusf_ammo_crate", "rhsusf_weapons_crate", "RHS_WEAPONS_CRATE_AK_AMMO_545X39", "rhs_weapons_crate_ak_ammo_545x39_standard"];
