...
IL_config = IL_config + [
	...
	[["C130J_Cargo","Cha_C130_Base"], false, [
	...
	[["APC_Wheeled_02_base_F","mas_BTR60_Base"], true, [
	...
	[["APC_Tracked_01_base_F","I_mas_BMP1_base"], true, [
...
IL_fnc_addAction = {
	...
	"
		...
		if (IL_Crew_Only) then { _show = (_show && ((_this == driver _target) OR (_this == commander _target) OR (_this in (vehicle _target call IL_fnc_returnTurretUnits)))) };
